...
def run_block(chr_id, start, stop):
    ...
    print('--- PAINTOR exec time: {}s ---'.format(round(stop - start), 5))
    ...
    stop = timeit.default_timer()
    print('--- CAVIARBF exec time: {}s ---'.format(round(stop - start), 5))
    ...
    stop = timeit.default_timer()
    print('--- FINEMAP exec time: {}s ---'.format(round(stop - start), 5))
